...
input_dir = "/hdfs/store/user/gparida/HHbbtt/Hadded_Skimmed_Files/Full_Production_CMSSW_13_0_13_Nov24_23/LooseSelection_MET_gt_80_nFatJet_gt_0_Skim/2018/"

with open("submit_all_Ganesh.sh", "w") as out:
    out.write("#!/bin/bash\n\n")
